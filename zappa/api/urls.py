...
urlpatterns = [
    ...
    path('newgame/', views.makeGame),
    path('addnewportfolio/<str:pk>', views.addNewPortfolio),
    path('addexistingportfolio/<str:pk>', views.addExistingPortfolio),
    path('removeportfolio/<str:pk>', views.removePortfolio),
